 ...
 */
EncodeDes::EncodeDes(std::string plaintext, std::string keyOne, std::string keyTwo) {
  if (keyOne.size() != 8) {
 ...
 */
std::string EncodeDes::getFinalPlaintext(void) { return finalPlaintext; }
 ...
 */
void EncodeDes::process(std::string textBinary, std::string keyOne,
                     std::string keyTwo) {
