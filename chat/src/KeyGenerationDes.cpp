 ...
 */
KeyGenerationDes::KeyGenerationDes(std::string key) {
  if (key.size() != 10) {
 ...
 */
std::string KeyGenerationDes::permutation(std::string key,
 ...
 * @return std::string Chave final
 */
std::string KeyGenerationDes::LS(std::string key, unsigned int time) {
  if (time == 0) {
 ...
 */
std::string KeyGenerationDes::keyLeft(std::string key) {
 ...
 */
std::string KeyGenerationDes::keyRight(std::string key) {
  unsigned int sizeKey = key.size();
  std::string finalKey;
 ...
 */
std::string KeyGenerationDes::getKey(unsigned int number) {
