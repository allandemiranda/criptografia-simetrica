 ...
 */
DecodeDes::DecodeDes(std::string plaintext, std::string keyOne, std::string keyTwo) {
  if (keyOne.size() != 8) {
 ...
 */
std::string DecodeDes::getFinalPlaintext(void) { return finalPlaintext; }
 ...
 */
void DecodeDes::process(std::string textBinary, std::string keyOne,
                     std::string keyTwo) {
